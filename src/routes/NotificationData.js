...
router.get('/customerProfile/:senderId', async (req, res) => {
  try {
...
router.get('/customerMessageForAdmin/:customerId', async (req, res) =>{
...
router.get('/adminMessageForCustomer', async (req, res) => {
