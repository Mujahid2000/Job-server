...
exports.resetPassword = exports.forgotPassword = exports.getUserByEmail = exports.registerUser = exports.loginUser = exports.getAllUsers = void 0;
...
const forgotPassword = (0, AsyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.status(200).json(new ApiResponse_1.ApiResponse(200, null, 'Password reset email sent'));
}));
exports.forgotPassword = forgotPassword;
const resetPassword = (0, AsyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { token, password } = req.body;
    yield user_service_1.userService.resetPassword(token, password);
    res.status(200).json(new ApiResponse_1.ApiResponse(200, null, 'Password reset successful'));
}));
