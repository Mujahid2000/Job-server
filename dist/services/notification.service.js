...
const customerMessage = (msgDataBody, io) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id, createdAt, updatedAt, __v } = msgDataBody, safeMsgBody = __rest(msgDataBody, ["_id", "createdAt", "updatedAt", "__v"]);
    const { senderId, name, email, receiverId } = safeMsgBody;
    const msgData = Object.assign(Object.assign({}, safeMsgBody), { dateWithTime: new Date().toLocaleString("en-US", { timeZone: "Asia/Dhaka" }) });
