...
const postContactInfo = (contactData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newContact = yield ContactSchema_1.default.findOneAndUpdate({ $or: [{ email }, { userId }] }, { $set: contactData }, { upsert: true, new: true, runValidators: true });
    return newContact;
});
const postSocialMediaInfo = (socialData) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId, socialLinks } = socialData;
    const newSocial = yield SocialMediaModel_1.default.findOneAndUpdate({ userId }, { $set: { userId, socialLinks } }, { upsert: true, new: true, runValidators: true });
    return newSocial;
});
