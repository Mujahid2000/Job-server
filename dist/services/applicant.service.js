...
const postApplicant = (applicantData, file) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updateData = Object.assign(Object.assign({}, applicantData), { profilePicture: profilePictureUrl });
    delete updateData.userId;
    const applicant = yield ApplicantModels_1.default.findOneAndUpdate({ userId }, { $set: updateData }, { upsert: true, new: true, runValidators: true });
    return applicant;
});
...
const postPersonalData = (personalData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const applicantPersonalData = yield CandidatePersonalDataSchema_1.default.findOneAndUpdate({ $or: [{ userId }, { email }] }, { $set: personalData }, { upsert: true, new: true, runValidators: true });
