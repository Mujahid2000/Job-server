...
const VerificationMiddleware_1 = __importDefault(require("./../middleware/VerificationMiddleware"));
/**
 * @swagger
 * tags:
 *   name: Companies
 ...
 */
router.route('/companyPersonal/:userId').get(VerificationMiddleware_1.default, (0, validateMiddleware_1.default)(company_validation_1.companyValidation.getParamsUserId), company_controller_1.getCompanyPersonalData);
/**
 * @swagger
 ...
 */
router.route('/companyProfile/:userId').get(VerificationMiddleware_1.default, (0, validateMiddleware_1.default)(company_validation_1.companyValidation.getParamsUserId), company_controller_1.getCompanyProfileData);
/**
 * @swagger
 ...
 */
router.route('/companySocialLink/:userId').get(VerificationMiddleware_1.default, (0, validateMiddleware_1.default)(company_validation_1.companyValidation.getParamsUserId), company_controller_1.getComapnySocialData);
/**
 * @swagger
 ...
 */
router.route('/companyContacts/:userId').get(VerificationMiddleware_1.default, (0, validateMiddleware_1.default)(company_validation_1.companyValidation.getParamsUserId), company_controller_1.getComapnyContactsData);
/**
 * @swagger
 ...
 */
router.route('/companyProfileComplete/:userId').get(VerificationMiddleware_1.default, (0, validateMiddleware_1.default)(company_validation_1.companyValidation.getParamsUserId), company_controller_1.getComapnyProfileCompleteData);
